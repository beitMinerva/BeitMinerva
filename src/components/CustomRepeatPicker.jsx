...
export default function CustomRepeatPicker({
  ...
  const options = [
    ...
    { id: 'every_2_months', label: 'Every 2 Months', desc: 'Bi-monthly schedule', icon: RotateCw },
    { id: 'every_3_months', label: 'Every 3 Months', desc: 'Recommended for Hoof Trimming', icon: RotateCw },
